 ...
 *
 * <p>Single repository used by both command and query handlers. Converts between the clean domain
 * model and the JPA persistence model.
 *
 * <p>With virtual threads (spring.threads.virtual.enabled=true), all JDBC blocking calls here are
